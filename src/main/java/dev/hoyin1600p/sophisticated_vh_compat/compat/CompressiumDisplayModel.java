...
public class CompressiumDisplayModel extends BakedModelWrapper<BakedModel> {
	private static final ResourceLocation MODEL_LOCATION = new ResourceLocation("sophisticated_vh_compat", "compressium_display");
	...
	private CompressiumDisplayModel(BakedModel original, AlphaMask mask) {
		...
		for (Direction direction : Direction.values()) {
			quads.put(direction, bakeMergedCompressiumFaceQuads(original.getParticleIcon(), mask, direction));
		}
